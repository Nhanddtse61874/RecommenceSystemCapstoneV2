...
namespace RecommenceSystemCapstoneV2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRecommenceHobbyService, RecommenceHobbyService>();
            ...
            services.AddDbContext<RSDbContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("RSCnnDbcontext")), ServiceLifetime.Transient);
        }
